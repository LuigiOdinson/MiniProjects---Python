...
def place(col, piece):
    # checking if the space over the piece is empty for the new piece
...
while True:
    if turn == 1:
        ...
        while selected_col not in range(0, 7):
            selected_col = int(input("Enter a valid column: "))
